...
var preferenceMapping = {
    addDescriptorToRequest: 'paymentGatewayPiaAddDescriptorToRequest',
 ...
 */
function Pia(order, args) {
    // default params
    var params = {
        paymentMethodID: require('*/cartridge/scripts/paymentgateway/helper/PaymentHelper').PAYMENT_METHOD_PIA,
        'transaction-type': Type.AUTHORIZATION,
        'merchant-account-id': this.getSitePreference('paymentGatewayPiaMerchantAccountID')
    };
...
Pia.prototype = Object.create(Transaction.prototype);

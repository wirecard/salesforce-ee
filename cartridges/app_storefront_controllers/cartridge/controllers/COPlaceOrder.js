...
function start() {
    ...
    if (handlePaymentsResult.error) {
        return Transaction.wrap(function () {
            ...
            return {
                error: true,
                PlaceOrderError: new Status(Status.ERROR, handlePaymentsResult.errorMsg || 'confirm.error.technical')
            };
        });
    ...
    } else if (handlePaymentsResult.redirectURL) {
        response.redirect(handlePaymentsResult.redirectURL);
        return {};
    }
